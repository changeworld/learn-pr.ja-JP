...
#### <a name="azure-the-big-picture"></a>Azure: 全体像
...
![Azure サービスの全体像を示す図](../media/2-azure-services.png "Azure サービス")
...
![Azure コンピューティング サービスの 3 つのタイプ、サービスとしてのインフラストラクチャ、サービスとしてのプラットフォーム、サービスとしての機能を示す図。 また、管理するコンポーネントと、各タイプのサービスの下で Azure によって管理されるコンポーネントも表示されます。](../media/2-iaas-paas-faas.png)

Azure での IaaS、PaaS、FaaS の例を次に示します。

|  種類  |  サービス名             | サービスの機能                                                         |
|--------|---------------------------|--------------------------------------------------------------------------|
| IaaS   | Azure Virtual Machines    | Azure でホストされる Windows または Linux 仮想マシン (VM)                  | 
