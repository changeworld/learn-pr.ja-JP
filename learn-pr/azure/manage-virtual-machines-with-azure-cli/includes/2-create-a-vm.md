<span data-ttu-id="fa2fc-101">最もわかりやすいタスクから始めましょう: Azure 仮想マシンの作成。</span><span class="sxs-lookup"><span data-stu-id="fa2fc-101">Let's start with the most obvious task: creating an Azure Virtual Machine.</span></span>
