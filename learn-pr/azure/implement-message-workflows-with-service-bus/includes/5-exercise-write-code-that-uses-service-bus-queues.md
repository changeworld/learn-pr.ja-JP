...
1. **[デバッグ]** ウィンドウのドロップダウン リストで、**[Private Message Sender を起動]** を選択して、**F5** キーを押します。 Visual Studio Code でデバッグ モードのコンソール アプリケーションがビルドされて実行されます。
...
1. **[デバッグ]** ウィンドウのドロップダウン リストで、**[Private Message Receiver を起動]** を選択して、**F5** キーを押します。 Visual Studio Code でデバッグ モードのコンソール アプリケーションがビルドされて実行されます。
